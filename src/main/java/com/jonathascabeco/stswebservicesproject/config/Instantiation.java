...
import com.jonathascabeco.stswebservicesproject.dto.AuthorDTO;
import com.jonathascabeco.stswebservicesproject.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Obrigado, tenha um ótico dia!", sdf.parse("23/03/2018"), new AuthorDTO(alex));
